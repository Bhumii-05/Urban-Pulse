...
export default function SignUp() {
        ...
        >
          ...
          <form className="mt-7 flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="fullName" className="text-[13px] font-semibold text-[#0B3D2E]">
                Full Name
              </label>
            ...
            {/* Email */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="email" className="text-[13px] font-semibold text-[#0B3D2E]">
                Email Address
              </label>
            ...
            {/* Phone Number */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="phone" className="text-[13px] font-semibold text-[#0B3D2E]">
                Phone Number
              </label>
            ...
            {/* Password */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="password" className="text-[13px] font-semibold text-[#0B3D2E]">
                Password
              </label>
            ...
            {/* Confirm Password */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="confirmPassword" className="text-[13px] font-semibold text-[#0B3D2E]">
                Confirm Password
              </label>
  ...
  className="mt-2 w-full rounded-xl bg-gradient-to-r from-[#0F9B76] to-[#4ADE80] py-3 text-[14.5px] font-semibold text-white shadow-[0_10px_25px_rgba(15,155,118,0.35)] transition-shadow duration-200 hover:shadow-[0_14px_32px_rgba(15,155,118,0.45)]"
>
  Sign Up
</motion.button>
          </form>
