...
const lifecycleSteps = [
  {
    step: "01",
    title: "Report",
    desc: "Citizen uploads photo and marks location on the map.",
    icon: MapPin,
  },
  {
    step: "02",
    title: "Check",
    desc: "System verifies duplicates and alerts local administration.",
    icon: FileCheck2,
  },
  {
    step: "03",
    title: "Dispatch",
    desc: "Automated route assignment straight to sanitation workers.",
    icon: Send,
  },
  {
    step: "04",
    title: "Verified Clean",
    desc: "Worker uploads completion proof before closing ticket.",
    icon: Sparkles,
  },
];
...
export default function AboutUs() {
  return (
    <section
      id="about"
      className="relative bg-[#F4F8F6] py-20 lg:py-28 overflow-hidden"
    >
      <div className="mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="mt-3 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            The <span className="text-[#005B4F]">UrbanPulse</span> Initiative
          </h2>
        ...
        {/* 1. Internship Recognition Card (Positioned Top) */}
        <motion.div
          initial={{ opacity: 0, y: 15 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="mb-16 rounded-3xl border border-emerald-900/10 bg-white p-6 sm:p-8 md:p-10 shadow-sm"
        >
          <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8">
            {/* Logo Badge */}
            <div className="h-28 w-28 sm:h-32 sm:w-32 shrink-0 rounded-2xl bg-black p-3 flex items-center justify-center shadow-md">
              <img
                src={jslLogo}
                alt="JSL Works Logo"
            ...
            <div className="flex-1 w-full space-y-2.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed text-justify">
                UrbanPulse was engineered during the 2026 Summer Internship
                Programme at JSL Works. Designed as a comprehensive smart waste
                platform, it streamlines municipal collection routes, integrates
                geo-tagged citizen issue reporting, and ensures full-cycle
                accountability across urban sectors.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        {/* 3. Full-Cycle Accountability Strip */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {lifecycleSteps.map((s, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="flex flex-col items-center text-center p-4 rounded-xl hover:bg-emerald-50/50 transition-colors"
                >
