 ...
 * Brief Description: Manages worker assignments and assignment statuses for administrators.
 */
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Track task assignments, worker progress, reported issues, and verified proofs.
            </p>
          </div>
        </div>
          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="bg-gray-50/80 text-gray-500 text-[11px] uppercase tracking-wide">
                ...
                <th className="px-5 py-3 text-left font-semibold">Status / Issue Reason</th>
                  ...
                  <tr key={item.id} className="hover:bg-emerald-50/30 transition">
                    ...
                    <td className="px-5 py-4">
                      <div className="space-y-1">
                        ...
                        {item.issue_reason && (
                          <p className="text-[11px] text-red-700 bg-red-50 border border-red-200 rounded-lg p-1.5 max-w-xs">
                            <strong>Reason:</strong> {item.issue_reason}
                          </p>
                        )}
                      </div>
                    </td>
