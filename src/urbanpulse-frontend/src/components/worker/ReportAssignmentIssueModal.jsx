...
const ASSIGNMENT_ISSUE_OPTIONS = [
  "Site Inaccessible / Road Blocked",
  "Hazardous / Unsafe Conditions",
  "Issue Already Cleared / Duplicate",
  "Incorrect Location / Not Found",
  "Special Machinery Required",
  "Other",
];

export default function ReportAssignmentIssueModal({
  assignment,
  onClose,
  onSubmit,
  submitting,
}) {
  const [selectedReason, setSelectedReason] = useState(ASSIGNMENT_ISSUE_OPTIONS[0]);
  ...
  const disabled =
    submitting || (selectedReason === "Other" && !customDescription.trim());
      ...
      <div className="w-full max-w-md rounded-3xl bg-white shadow-2xl border border-slate-100 overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            >
              {ASSIGNMENT_ISSUE_OPTIONS.map((opt) => (
            ...
            <textarea
              ...
              placeholder={
                selectedReason === "Other"
                  ...
                  : "e.g. Area blocked off by emergency maintenance..."
              }
