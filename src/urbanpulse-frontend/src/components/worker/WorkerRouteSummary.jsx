 ...
 * Brief Description: Displays a summary of the worker's assigned collection route.
 */
          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            {routes.length > 1 ? (
              <div className="relative" ref={dropdownRef}>
                ...
                <div
                  className={`absolute left-0 mt-2 w-72 sm:w-80 bg-white rounded-2xl shadow-2xl ring-1 ring-black/5 border border-slate-100 p-1.5 z-50 transition-all duration-200 ${
