...
// Dynamically pans the map when user location is obtained
...
export default function SuggestionDrawer({
  ...
  // Attempt to fetch user's live GPS coordinates when drawer opens
  const fetchUserLocation = () => {
    if ("geolocation" in navigator) {
      ...
      navigator.geolocation.getCurrentPosition(
        ...
        () => {
          // If denied or timed out, fallback gracefully to Delhi
          setLocating(false);
        },
