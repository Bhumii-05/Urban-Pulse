...
Brief Description: Orchestrates the complete Retrieval-Augmented Generation workflow from query retrieval and context construction to prompt generation, LLM response parsing, and fallback handling.
"""
