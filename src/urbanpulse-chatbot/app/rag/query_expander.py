...
Brief Description: Expands common resident waste-management terminology with related terms to improve semantic retrieval from the municipal knowledge base.
"""
