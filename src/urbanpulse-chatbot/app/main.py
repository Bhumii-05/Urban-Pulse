...
Brief Description: Initializes the FastAPI application, configures CORS, registers exception handlers and API routers, and provides root and health-check endpoints.
"""
